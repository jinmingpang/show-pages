...
},{"_css_loader":17}],14:[function(require,module,exports) {
...
(function (window) {
    ...
    Element.prototype.fullpage = function (option) {
        return new Fullpage(this, option);
             ...
             */
},{"constants":20}],19:[function(require,module,exports) {
...
},{"_css_loader":17}],26:[function(require,module,exports) {
...
exports.afterChangePage = exports.onChagePange = exports.beforeChangePage = exports.getPageByHash = exports.setPageHash = exports.loadHtml = exports.PAGE_KEY = undefined;
...
var PAGE_KEY = exports.PAGE_KEY = '_page';

var loadHtml = exports.loadHtml = function loadHtml() {

  var html = '\n    <article class="fullpage-wrapper">\n    {{ each pages}}\n      <section class="page page-{{index+1}}" data-index={{index+1}}></section>\n    {{ /each }}\n    </article>\n  ';

  document.querySelector('.root').innerHTML = _artTempalte2.default.render(html, { pages: GLOBAL.pages });
};

var setPageHash = exports.setPageHash = function setPageHash(page) {
...
var getPageByHash = exports.getPageByHash = function getPageByHash() {
  ...
  var page = arr[arr.indexOf(PAGE_KEY) + 1];
...
var beforeChangePage = exports.beforeChangePage = function beforeChangePage() {
  location.href = '';
};

var onChagePange = exports.onChagePange = function onChagePange() {};

var afterChangePage = exports.afterChangePage = function afterChangePage() {};
},{"../lib/art-tempalte":26}],4:[function(require,module,exports) {
'use strict';
...
init();
},{"../../example/page.yaml":6,"../../app.json":8,"../lib/normalize/index.css":12,"../lib/fullpage/index.css":14,"../lib/fullpage":18,"../lib/fiexible":19,"../css/index.styl":10,"./page":23}],30:[function(require,module,exports) {
